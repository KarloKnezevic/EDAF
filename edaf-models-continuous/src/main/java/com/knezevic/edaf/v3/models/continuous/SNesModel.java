...
/**
 * Separable NES strategy model scaffold.
 *
 * TODO(priority=medium): Implement natural-gradient updates for mean and diagonal sigma.
 */
public final class SNesModel implements Model<RealVector> {

    private final DiagonalGaussianModel fallback = new DiagonalGaussianModel(1e-8);
    ...
    public ModelDiagnostics diagnostics() {
        ...
        values.put("nes_gradient_norm", 0.0);
