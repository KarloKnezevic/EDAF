...
/**
 * Copula baseline scaffold model.
 *
 * TODO(priority=high): Replace fallback with rank-transform marginals and Gaussian copula dependency sampling.
 */
public final class CopulaBaselineModel implements Model<RealVector> {
    ...
    public ModelDiagnostics diagnostics() {
        ...
        values.put("copula_rank_dependence", 0.0);
