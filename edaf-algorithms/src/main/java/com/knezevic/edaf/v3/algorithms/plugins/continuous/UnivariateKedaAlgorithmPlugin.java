 ...
 * @version EDAF 3.0.0
 */
public final class UnivariateKedaAlgorithmPlugin implements AlgorithmPlugin<RealVector> {
    ...
    public String description() {
        return "Univariate KDE-EDA literature alias";
    }
