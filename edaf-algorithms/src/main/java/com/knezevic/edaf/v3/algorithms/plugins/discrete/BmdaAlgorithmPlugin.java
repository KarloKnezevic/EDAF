...
import com.knezevic.edaf.v3.algorithms.discrete.BmdaAlgorithm;
 ...
 */
public final class BmdaAlgorithmPlugin implements AlgorithmPlugin<BitString> {
    ...
    public Algorithm<BitString> create(AlgorithmDependencies<BitString> dependencies, Map<String, Object> params) {
        return new BmdaAlgorithm(Params.dbl(params, "selectionRatio", 0.5));
    }
}
