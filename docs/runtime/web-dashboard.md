...
- `<repo-root>/configs/docs/web-screenshot-onemax.yml`
- `<repo-root>/configs/docs/web-screenshot-adaptive.yml`
- `<repo-root>/configs/docs/web-screenshot-grammar-tree-umda.yml`
- `<repo-root>/configs/docs/web-screenshot-grammar-tree-boa.yml`
- `<repo-root>/configs/docs/web-screenshot-grammar-tree-chow-liu.yml`
- `<repo-root>/configs/docs/web-screenshot-grammar-tree-hboa.yml`
