...
- `<repo-root>/configs/coco/bbob-smoke-v3.yml`
- `<repo-root>/configs/coco/bbob-campaign-v3.yml`
- `<repo-root>/configs/coco/bbob-publishable-v3.yml`
- `<repo-root>/configs/coco/bbob-publishable-v4.yml`
...
- BBOB objective implementation:
  - `<repo-root>/edaf-problems/src/main/java/com/knezevic/edaf/v3/problems/coco/BbobFunctions.java`
- Problem plugin registration:
  - `<repo-root>/edaf-problems/src/main/java/com/knezevic/edaf/v3/problems/plugins/continuous/CocoBbobProblemPlugin.java`
- Campaign orchestration:
  - `<repo-root>/edaf-coco/src/main/java/com/knezevic/edaf/v3/coco/runner/CocoCampaignRunner.java`
