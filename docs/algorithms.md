...
| `boa` | discrete | `RatioBasedEdaAlgorithm` via plugin | `boa-ebna` | working scaffold |
...
| `cma-es` | continuous | `RatioBasedEdaAlgorithm` via plugin | `cma-es` | working scaffold |
