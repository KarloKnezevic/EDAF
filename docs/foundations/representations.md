...
See [Configuration Reference](../foundations/configuration.md) for exact compatibility lists.
...
Detailed walkthrough: [Extending the Framework](../foundations/extending-the-framework.md).
