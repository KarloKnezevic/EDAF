...
For measured runtime baselines and reproducible commands, see [Complexity and Performance](../benchmarks/complexity-and-performance.md).
...
Reference list is provided in [Bibliography](../references/bibliography.md).
