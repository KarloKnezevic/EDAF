...
- `<repo-root>/edaf-cli/target/edaf-cli.jar`
- `<repo-root>/edaf-web/target/edaf-web-3.0.0.jar`
- module jars under each `*/target/`
- `<repo-root>/dist/v3.0.0/*` (local release bundle; intentionally ignored in git)
...
- workflow: `<repo-root>/.github/workflows/release-on-tag.yml`
...
- `<repo-root>/.readthedocs.yaml`
- `<repo-root>/mkdocs.yml`
- `<repo-root>/docs/requirements-rtd.txt`
